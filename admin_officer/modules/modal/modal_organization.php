        ...
        <div class="modal-content">
            ...
            <form id="form_upload" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="d-flex">
                        <input type="file" name="add_file_list" class="form-control " id="add_file_list">
                        <button type="button" class="btn btn-primary" id="submit5">Submit</button>
                    </div>
                    <br>
                    <label data-error="wrong" data-success="right">Roster<span class="text-danger">*</span></label>
                    <div class="d-flex">
                        <input type="file" name="add_file_roster" class="form-control " id="add_file_roster">
                        <button type="button" class="btn btn-primary" id="submit6">Submit</button>
                    </div>
                    <br>
                </div>
                <div class="modal-footer">
...
<div class="modal fade" id="upload_excel_modal">
     <div class="modal-dialog">
         <div class="modal-content">
             ...
             <form id="upload_logo" enctype="multipart/form-data">
                 <div class="modal-body">
                 <div class="form-group">
                    <input type="hidden" name="logo_id" id ="logo_id">
                    <input type="file" name="logo_file" id="logo_file" class="form-control"><br><br>
                 </div>
                 <div class="modal-footer">
                     <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
