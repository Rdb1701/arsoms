                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group col-12 col-md-4">
                            ...
                            <textarea name="edit_mission" id="edit_mission" cols="30" rows="5" class="form-control" required></textarea>
                        </div>
                        <div class="form-group col-12 col-md-4">
                            <label for="vision">Vision <span class="text-danger">*</span></label>
                            <textarea name="edit_vision" id="edit_vision" cols="30" rows="5" class="form-control" required></textarea>
                        </div>
                        <div class="form-group col-12 col-md-4">
                            <label for="edit_goals">Goals<span class="text-danger">*</span></label>
                            <textarea name="edit_goals" id="edit_goals" cols="30" rows="5" class="form-control" required></textarea>
                        </div>
                    </div>
                </div>
