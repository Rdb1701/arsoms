...
WHERE pay.status = '2' and org.user_id = '".$_SESSION['officer']['admin_org_id']."'
ORDER BY stud.lname
";
...
foreach($payments as $key => $value){
    ...
    $data['data'][] = array($value['fname'].' '.$value['lname'],$value['year_level'],$value['event_desc'],$value['event_date'].' - '.$value['last_event_date'],'₱ '.$value['fee'],$value['sanction_remarks'],$button);
  }
