...
WHERE pay.status = '3' AND org.user_id = '".$_SESSION['officer']['admin_org_id']."'
...
<h1 style="margin: 0; padding: 0; text-align: center; line-height: 0;">SUNCTION FEE COLLECTIONS</h1>
<p></p>
<br>
</div>
...
$pdf->Output('Sanction Collections.pdf', 'I');
