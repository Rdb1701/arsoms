      ...
      <form id="form_change_password">
        <div class="modal-body mx-4">
          ...
          <div class="md-form">
            ...
            <input type="text" class="form-control" value="<?php echo $_SESSION['admin_org']['officer']; ?>" readonly>
          </div>
          <div class="md-form">
            <label data-error="wrong" data-success="right">Email<span class="text-danger">*</span></label>
            <input type="email" class="form-control" id="my_email" autocomplete="off" value="<?php echo $_SESSION['admin_org']['officer']; ?>">
          </div>
