...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion bg-dark" id="accordionSidebar">
      ...
      WHERE org.user_id = '" . $_SESSION['officer']['admin_org_id'] . "' AND org.status = '1'
      ";
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['officer']['fname'] ?> <?php echo $_SESSION['officer']['lname'] ?></span>
