...
include 'paids/paid_search_print.php';
?>
...
<div class="">
    ...
    <table class="table table-bordered">
        <thead>
            ...
            <tr>
                <th class="text-center fw-bold bg-success text-white">Payment</th>
                <th class="text-center fw-bold bg-success text-white" style="width: 2px;">:</th>
                <th id=""><?php echo $fee; ?></th>
            </tr>
            <tr>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $pay['lname']; ?> <?php echo $pay['fname']; ?></td>
                                    <td class="text-center"><?php echo $pay['concatqr']; ?></td>
                                </tr>
                            <?php }
                        } else { ?>
                            <tr>
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    message: function() {
                        ...
                        message += '<h6><center>PAID PAYMENTS</center><h6><br><br><br><br>';
                        ...
                        message += '<span class="font-weight-bold">Payment:</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="payment_iddd">₱ <?php echo $fee ? $fee : 'No Data Found'; ?></span><br><br>';
                        return message;
                    },
