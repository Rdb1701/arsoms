...
$opt2 = "<select class='form-control' name='add_event_p' id = 'add_event_p' onchange = 'change_event()' required>";
            ...
            <form id="form_payment_pr">
                ...
                <div class="md-form">
                    ...
                    <div class="md-form">
                        ...
                        <textarea class = "form-control" cols="10" rows="5" id ="add_remark" name = "add_remark" required></textarea>
                    </div>

                    <div class="md-form" >
                        <table class="table" id="sanction_table">
                            <thead>
