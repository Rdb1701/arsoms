...
// $sql = "SELECT ev.event_id, org.organization_id, ev.event_desc, org.org_name FROM tbl_events as ev
            ...
            <form id="form_payment">
                <div class="modal-body">
                    ...
                    <div class="md-form">
                        ...
                        <input type="number" class="form-control validate" id="add_fee" name="add_fee" required>
                    </div><br>
                    <div class="md-form">
